...
public class ListaEstudiante {
    ...
    public void elimina(Estudiante elemento) {
        ...
        while (viajero != null) {
            if (viajero.get().equals(elemento)) {
                if (viajero == cabeza && viajero == rabo) {
                    cabeza = null;
                    rabo = null;
                } else if (viajero == cabeza) {
                    viajero.siguiente.anterior = null;
                    cabeza = viajero.siguiente;
                } else if (viajero == rabo) {
                    viajero.anterior.siguiente = null;
                    rabo = viajero.anterior;
                } else {
    ...
    public boolean equals(ListaEstudiante lista) {
        ...
        // Aquí va su código.
        Nodo viajero1 = cabeza;
        Nodo viajero2 = lista.cabeza;

        while (viajero1 != null && viajero2 != null) {
            if (!viajero1.elemento.equals(viajero2.elemento)) {
                return false;
            }
            viajero1 = viajero1.siguiente;
